...
public class CinemaReservationOptimised1 {
	...
	public static void main(String[] args) {
		...
		cinemaReservation
				.displayCinemaPlacesLayout(allPlaces, false, cinemaReservation.rowReserved, cinemaReservation.startingPosition,
	...
	private void findIfReservationIsPossible(final boolean[][] allPlaces, int rowNum, int numPlaces) {
		...
		while (indexTested < PLACES_PER_ROW) {
			if (isThisPlaceEligible(indexTested, numPlaces, rowPlaces)) {
				...
				displayCinemaPlacesLayout(allPlaces, true, rowReserved, startingPosition,
	...
	private void displayCinemaPlacesLayout(final boolean[][] allPlaces, boolean flagReservedOnly, int rowReserved,
			int startingPosition, int endPosition) {
